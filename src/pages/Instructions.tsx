    ...
    <div className="min-h-screen bg-[#0A1629] text-white">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#A3B1C6]">Learn the rules of Portfolio Panic</p>
        </div>
        ...
        <div className="space-y-6">
            ...
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                <div className="bg-[#FF6B00]/20 p-3 rounded-full">
                  <Info className="text-[#FF6B00]" size={24} />
                </div>
                <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  <div className="bg-[#0A1629] p-3 rounded-full">
                    <Clock className="text-[#A3B1C6]" size={24} />
                  </div>
                  <div>
            ...
            <Card className="bg-[#132237] border-none rounded-xl overflow-hidden">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  <div className="bg-[#0A1629] p-3 rounded-full">
                    <DollarSign className="text-[#A3B1C6]" size={24} />
                  </div>
                  <div>
            ...
            <Card className="bg-[#132237] border-none rounded-xl overflow-hidden">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  <div className="bg-[#0A1629] p-3 rounded-full">
                    <TrendingUp className="text-[#A3B1C6]" size={24} />
                  </div>
                  <div>
            ...
            <Card className="bg-[#132237] border-none rounded-xl overflow-hidden">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  <div className="bg-[#0A1629] p-3 rounded-full">
                    <ChevronRight className="text-[#A3B1C6]" size={24} />
                  </div>
                  <div>
          ...
          <div className="bg-[#FF6B00]/10 border border-[#FF6B00]/30 rounded-lg p-4 mt-6">
